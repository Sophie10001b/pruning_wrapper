            ...
            for batch_size in args.batch_size:
                for seq_len in args.seq_len:
                    try:
                        ...
                        res_dict[(batch_size, seq_len, f"{sparsity:.2f}")] = [(token_num / ms) * 1000.0, (token_num / max_ms) * 1000.0, (token_num / min_ms) * 1000.0]
                    except Exception as e:
                        print(f"[ERROR] {e}")
                        res_dict[(batch_size, seq_len, f"{sparsity:.2f}")] = [0, 0, 0]
